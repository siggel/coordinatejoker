...
## Kurzversion:
Persönliche Daten werden durch Coordinate Joker weder erfasst, noch verarbeitet, gespeichert oder gelöscht.

Trotzdem sollte man sich bewusst sein, dass Coordinate Joker die generierten Wegpunkte an die vom Benutzer gewählte App zur Darstellung weitergibt. Eine mögliche Verknüpfung mit weiteren, auch personenbezogenen Daten innerhalb jener App liegt außerhalb des Einflussbereichs von Coordinate Joker.

Bei Kontaktaufnahme werden ggf. Kontaktdaten (E-Mail-Adresse, Anschrift und/oder Telefonnummer) zum Zweck und für die Dauer der Bearbeitung der Anfrage gespeichert (Artikel 6 (1) b) DSGVO).

Für die Bereitstellung von Coordinate Joker und von zugehörigen Webseiten werden folgende Angebote Dritter genutzt, denen eigene Datenschutzgrundsätze zugrundeliegen:

* Google Play Store  
* GitHub  
* Google Sites (ehemals Website Host)  
